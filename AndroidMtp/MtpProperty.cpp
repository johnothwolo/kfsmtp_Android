    ...
    if (defaultValue) {
        switch (type) {
            ...
            case MTP_TYPE_UINT64:
                ...
                break;
            default:
                fprintf(stderr, "unknown type %04X in MtpProperty::MtpProperty\n", type);
        }
    }
}
...
void MtpProperty::setFormRange(int min, int max, int step) {
    ...
    switch (mType) {
        ...
        case MTP_TYPE_UINT64:
            ...
            break;
        default:
            fprintf(stderr, "unsupported type for MtpProperty::setRange\n");;
            break;
    }
}
        ...
        int value = *values++;
            switch (mType) {
                ...
                case MTP_TYPE_UINT64:
                    ...
                    break;
                default:
                    fprintf(stderr, "unsupported type for MtpProperty::setEnum\n");;
                    break;
        }
    }
}
...
void MtpProperty::print() {
    ...
    bool deviceProp = isDeviceProperty();
    if (deviceProp)
        fprintf(stdout, "    %s (%04X)\n", MtpDebug::getDevicePropCodeName(mCode), mCode);
    else
        fprintf(stdout, "    %s (%04X)\n", MtpDebug::getObjectPropCodeName(mCode), mCode);
    fprintf(stdout, "    type %04X\n", mType);
    fprintf(stdout, "    writeable %s", (mWriteable ? "true" : "false\n"));
...
void MtpProperty::print(MtpPropertyValue& value, std::string& buffer) {
    ...
    switch (mType) {
        ...
        case MTP_TYPE_STR:
            ...
            break;
        default:
            fprintf(stderr, "unsupported type for MtpProperty::print\n");;
            break;
    }
}
...
bool MtpProperty::readValue(MtpDataPacket& packet, MtpPropertyValue& value) {
    ...
    switch (mType) {
        ...
        case MTP_TYPE_STR:
            ...
            break;
        default:
            fprintf(stderr, "unknown type %04X in MtpProperty::readValue\n", mType);
            return false;
    }
    return true;
}
...
void MtpProperty::writeValue(MtpDataPacket& packet, MtpPropertyValue& value) {
    ...
    switch (mType) {
        ...
        case MTP_TYPE_STR:
            ...
            break;
        default:
            fprintf(stderr, "unknown type %04X in MtpProperty::writeValue\n", mType);
    }
}
